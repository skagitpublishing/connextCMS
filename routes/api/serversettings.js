...
var serverSettings = require('../../private/serversettings.json');
...
exports.save = function(req, res) {
  ...
  fs.writeFile('../../private/serversettings.json', JSON.stringify(data, null, 4), function (err) {
    if(err) {
      ...
      console.log('/api/serversettings/save executed. serversettings.json updated.');
