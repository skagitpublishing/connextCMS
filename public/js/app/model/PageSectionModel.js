define([
  ...
  var PageSectionModel = Backbone.Model.extend({
    ...
    //url: 'http://'+global.serverIp+':'+global.serverPort+'/api/pagesection/'+this.id+'/update', 
    url: '',
    ...
    initialize: function() {
      ...
      this.url = 'http://'+global.serverIp+':'+global.serverPort+'/api/pagesection/'+this.id+'/update';
    },
    ...
    save: function() {
      ...
      $.getJSON(this.url, this.attributes, function(data) {
        ...
        //debugger;
        log.push('PageSectionModel.save() executed.');
        ...
        //debugger;
        log.push('Error while trying PageSectionModel.save(). Most likely due to communication issue with the server.');
        log.push('Error message: '+err.message);
        sendLog();
        console.error('Communication error with server while execute PageSectionModel.save()');
      });
