            ...
            onclick: function() {
              ...
              editor.undoManager.transact(function() {
                ...
                try {
                  ...
                  //Handle Alignment
                  if( imgAlign == "center" ) {
                    preHTML = "<div class='center-block' style='text-align: center; width: "+divWidth+"; border-style: solid; border-width: 1px; margin: 15px;'>";
                    postHTML = "</div>";
                  } else if( imgAlign == "right") {
                    preHTML = "<div style='float: right; width: "+divWidth+"; border-style: solid; border-width: 1px; margin: 15px;'>";
                    postHTML = "</div>";
                  } else if( imgAlign == "left") {
                    preHTML = "<div style='float: left; width: "+divWidth+"; border-style: solid; border-width: 1px; margin: 15px;'>";
                    postHTML = "</div>";
                  }
                  ...
                  if( caption != "" ) {
                    ...
                    postHTML = '<figcaption class="text-center">'+caption+'</figcaption></figure>'+postHTML;
                  }
